...
<head>
  ...
  <!-- =======================================================
  * Template Name: Unit - v4.7.0
  * Template URL: https://bootstrapmade.com/real-UnitBox-agency-bootstrap-template/
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">Unit<span class="color-b">Box</span></a>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">UnitBox</h3>
            </div>
            <div class="w-body-a">
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Phone .</span> contact@unitbox.com
                </li>
                <li class="color-a">
                  <span class="color-text-a">Email .</span> +55 11 98222-8252
                </li>
                <li class="color-a">
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">Unit</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <!--
            ...
            Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/buy/?theme=Unit
          -->
